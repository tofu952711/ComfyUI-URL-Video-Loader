        ...
        **kwargs
        ...
        if format_type == "image":
            ...
            if audio is not None:
                try:
                    #safely check if audio produced by KKvideo_LoadVideo actually exists
...
class BatchManager:
    ...
    RETURN_TYPES = ("KKvideo_BatchManager",)
...
NODE_CLASS_MAPPINGS = {
    "KKvideo_LoadVideoFFmpeg": LoadVideoFFmpegUpload,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "KKvideo_LoadVideoFFmpeg": "URL Load Video KKvideo",
}
