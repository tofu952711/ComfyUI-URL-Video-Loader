...
@server.PromptServer.instance.routes.get("/kkvideo/viewvideo")
async def view_video(request):
    ...
    try:
        ...
        pass
    return resp
@server.PromptServer.instance.routes.get("/kkvideo/viewaudio")
...
query_cache = {}
@server.PromptServer.instance.routes.get("/kkvideo/queryvideo")
...
@server.PromptServer.instance.routes.get("/kkvideo/getpath")
